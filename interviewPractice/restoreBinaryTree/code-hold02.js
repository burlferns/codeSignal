...
function restoreBinaryTree(inorder, preorder) {
    ...
    //The rootNum is the number of values in the root's sub-tree. It should be calculated from
    //the inorder index range values of the root's tree  
    let rootNum = rootEndInOrder - rootBeginInOrder + 1;
