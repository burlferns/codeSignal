...
this works upto test 8 now whereas before it would take too long to do test 8

now however it fails test 9
...
function wordBoggle(board, words) {
    ...
    // tempSet.add('2,0')
    // const startStackItem = ['C',[2,0],tempSet,1];
    // const foundWord = dfsSearch('COOL',startStackItem);
